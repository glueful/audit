...
namespace Glueful\Extensions\Audit\Tests\Integration\Schema;
...
final class SchemaVerifierBehaviorTest extends TestCase
{
    ...
    private AuditSchemaVerifier $verifier;
    private string $dbPath;

    protected function setUp(): void
    {
        $this->dbPath = sys_get_temp_dir() . '/audit-verify-' . uniqid('', true) . '.sqlite';
        ...
        $this->verifier = new AuditSchemaVerifier();
    }
